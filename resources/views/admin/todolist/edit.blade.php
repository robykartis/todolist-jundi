        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form action="{{ route('todolist.update', $data_todolist->id) }}" method="POST">
                        @csrf
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="deskripsi" class="form-control  @error('deskripsi') is-invalid @enderror" rows="4" cols="50"
                                        placeholder="Enter a description...">{{ old('deskripsi', $data_todolist->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="date" name="tanggal"
                                        value="{{ old('tanggal', $data_todolist->tanggal) }}"
