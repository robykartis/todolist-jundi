                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                            <div class="d-flex align-items-center">
                                ...
                                <div
                                    class="w-64-px h-64-px radius-16 bg-base-50 d-flex justify-content-center align-items-center me-20">
                                    <span
                                        class="mb-0 w-40-px h-40-px bg-purple flex-shrink-0 text-white d-flex justify-content-center align-items-center radius-8 h6 mb-0">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                            <div class="d-flex align-items-center">
                                ...
                                <div
                                    class="w-64-px h-64-px radius-16 bg-base-50 d-flex justify-content-center align-items-center me-20">
                                    <span
                                        class="mb-0 w-40-px h-40-px bg-red flex-shrink-0 text-white d-flex justify-content-center align-items-center radius-8 h6 mb-0">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                            <div class="d-flex align-items-center">
                                ...
                                <div
                                    class="w-64-px h-64-px radius-16 bg-base-50 d-flex justify-content-center align-items-center me-20">
                                    <span
                                        class="mb-0 w-40-px h-40-px bg-success-main flex-shrink-0 text-white d-flex justify-content-center align-items-center radius-8 h6 mb-0">
                        ...
                        <div class="mt-24 mb-24 d-flex flex-wrap">
                            <div class="me-40">
                                ...
                                <div class="">
                                    ...
                                    <span class="text-success-main fw-bold d-inline-flex align-items-center gap-1">10%
                            ...
                            <div>
                                ...
                                <div class="">
                                    ...
                                    <span class="text-danger-main fw-bold d-inline-flex align-items-center gap-1">10%
                    ...
                    <div class="card-body p-24">
                        ...
                        <div class="mt-24">
                            <div class="d-flex align-items-center gap-1 justify-content-between mb-44">
                                <div>
                                    <span class="text-secondary-light fw-normal mb-12 text-xl">Daily
                                        Conversions</span>
                                ...
                                <div class="position-relative">
                                    ...
                                    <span
                                        class="w-36-px h-36-px rounded-circle bg-neutral-100 d-flex justify-content-center align-items-center position-absolute start-50 translate-middle bottom-0"><iconify-icon
                                            icon="mdi:emoji" class="text-primary-600 text-md mb-0"></iconify-icon></span>
                                </div>
                            </div>
            ...
            <div class="col-xxl-3">
                <div class="card h-100 radius-8 border-0">
                    <div class="card-body p-24">
                        ...
                        <div class="position-relative">
                            <span
                                class="w-80-px h-80-px bg-base shadow text-primary-light fw-bold text-xxl d-flex justify-content-center align-items-center rounded-circle position-absolute end-0 top-0 z-1">20k</span>
                            <div id="statisticsDonutChart"
                                class="mt-36 flex-grow-1 apexcharts-tooltip-z-none title-style circle-none"></div>
                            <span
                                class="w-80-px h-80-px bg-base shadow text-primary-light fw-bold text-xxl d-flex justify-content-center align-items-center rounded-circle position-absolute start-0 bottom-0 z-1">50k</span>
                        </div>
                            ...
                            <table class="table bordered-table sm-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/asset/asset-img1.png" alt=""
                                                    class="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12">
                                                <div class="flex-grow-1">
                                                    <h6 class="text-md mb-0 fw-normal">Gold</h6>
                                                    <span class="text-sm text-secondary-light fw-normal">Main
                                                        Asset</span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/asset/asset-img2.png" alt=""
                                                    class="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12">
                                                <div class="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/asset/asset-img3.png" alt=""
                                                    class="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12">
                                                <div class="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/asset/asset-img4.png" alt=""
                                                    class="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12">
                                                <div class="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/asset/asset-img5.png" alt=""
                                                    class="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12">
                                                <div class="flex-grow-1">
                ...
                <div class="card h-100">
                    <div class="card-body p-24">
                        ...
                        <div class="d-flex align-items-start gap-2 mb-20">
                            <img src="assets/images/notice/board-img1.png" alt=""
                                class="flex-shrink-0 w-40-px h-40-px me-12 radius-8 me-12">
                            <div class="flex-grow-1">
                                <h6 class="text-md mb-1 fw-semibold">Admin</h6>
                                <p class="text-sm text-secondary-light fw-medium mb-1">Lorem Ipsum is simply dummy
                                    text of the printing and typesetting industry. Lorem Ipsum is simply dummy.</p>
                                <span class="text-sm text-secondary-light fw-normal">25 Jan 2024</span>
                            </div>
                        </div>

                        <div class="d-flex align-items-start gap-2 mb-20">
                            <img src="assets/images/notice/board-img2.png" alt=""
                                class="flex-shrink-0 w-40-px h-40-px me-12 radius-8 me-12">
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-start gap-2">
                            <img src="assets/images/notice/board-img3.png" alt=""
                                class="flex-shrink-0 w-40-px h-40-px me-12 radius-8 me-12">
                            <div class="flex-grow-1">
                                <h6 class="text-md mb-1 fw-semibold">Cameron Williamson</h6>
                                <p class="text-sm text-secondary-light fw-medium mb-1">Lorem Ipsum is simply dummy
                                    text of the printing Lorem Ipsum is simply dummy text of the printing and
                                            ...
                                            <div class="max-w-112 mx-auto">
                                                <div class="w-100">
                                                    <div class="progress progress-sm rounded-pill" role="progressbar"
                                                        aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                                        aria-valuemax="100">
                                                        <div class="progress-bar bg-red rounded-pill" style="width: 30%;">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="max-w-112 mx-auto">
                                                <div class="w-100">
                                                    <div class="progress progress-sm rounded-pill" role="progressbar"
                                                        aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                                        aria-valuemax="100">
                                                        <div class="progress-bar bg-warning-main rounded-pill"
                                                            style="width: 50%;"></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="max-w-112 mx-auto">
                                                <div class="w-100">
                                                    <div class="progress progress-sm rounded-pill" role="progressbar"
                                                        aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                                        aria-valuemax="100">
                                                        <div class="progress-bar bg-red rounded-pill" style="width: 70%;">
                                                        </div>
                                                    </div>
                                                </div>
